...
#define L3_DEVICE_CHECK(is_ipv4, flags)                              \
do {                                                                 \
...
check(struct __ctx_buff *ctx, bool is_ipv4)
{
	...
	/*
	 * Ensure L3_DEVICE_CHECK and CLS_FLAG_VXLAN is set with MARK_MAGIC_OVERLAY.
	 */
	...
	/*
	 * Ensure L3_DEVICE_CHECK and CLS_FLAG_VXLAN is set with UDP and TUNNEL_PORT.
	 */
